...
if __name__ == "__main__":
    ...
    npc = SingleAgentEnv(env_config, "npc", isTuner = True)
        

    unray_config = UnrayConfig()

    unray_config.configure_tune(npc)
    ...
    tuner = tune.Tuner(
        ...
        run_config=air.RunConfig(stop=stopping_criteria, checkpoint_config=air.CheckpointConfig(checkpoint_frequency=5)),
    )
    results = tuner.fit()
